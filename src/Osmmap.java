...
<head>
 ...
 var codesite_token = "EriFFnQ3ojVGygN--kN3O9097B0:1376910200872";
 
 
 var CS_env = {"relativeBaseUrl":"","assetVersionPath":"http://www.gstatic.com/codesite/ph/16876283342775096309","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","token":"EriFFnQ3ojVGygN--kN3O9097B0:1376910200872","projectName":"landmarkloc","loggedInUserEmail":"rahulveera2009@gmail.com","projectHomeUrl":"/p/landmarkloc","profileUrl":"/u/101147021809914525860/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Flandmarkloc%2Fsource%2Fbrowse%2Ftrunk%2FOsmmap.java" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/landmarkloc/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>Osmmap.java</span>
 ...
 <a href="/p/landmarkloc/source/browse/trunk/Osmmap.java?edit=1"
...
><td class="source">import org.osmdroid.tileprovider.tilesource.TileSourceFactory;<br></td></tr
><tr
id=sl_svn4_8

 onmouseover="gutterOver(8)"

><td class="source">import org.osmdroid.util.GeoPoint;<br></td></tr
><tr
id=sl_svn4_9

 onmouseover="gutterOver(9)"

><td class="source">import org.osmdroid.views.MapView;<br></td></tr
><tr
id=sl_svn4_10

 onmouseover="gutterOver(10)"

><td class="source">//import org.osmdroid.tileprovider.tilesource.BitmapTileSourceBase;<br></td></tr
><tr
id=sl_svn4_11
...
><td class="source">public class Osmmap extends Activity {<br></td></tr
><tr
id=sl_svn4_13
...
><td class="source">    private MapView m_mapView;<br></td></tr
><tr
id=sl_svn4_15

 onmouseover="gutterOver(15)"

><td class="source">    private TextView m_textView;<br></td></tr
><tr
id=sl_svn4_16

 onmouseover="gutterOver(16)"

><td class="source">    private int MAP_DEFAULT_ZOOM = 12;<br></td></tr
><tr
id=sl_svn4_17

 onmouseover="gutterOver(17)"

><td class="source">    private double MAP_DEFAULT_LATITUDE = 12.966667;<br></td></tr
><tr
id=sl_svn4_18

 onmouseover="gutterOver(18)"

><td class="source">    private double MAP_DEFAULT_LONGITUDE = 77.566667;<br></td></tr
><tr
id=sl_svn4_19
...
><td class="source">        setContentView(R.layout.osmmap);<br></td></tr
><tr
id=sl_svn4_24
...
><td class="source">        m_mapView = (MapView) findViewById(R.id.mapview);<br></td></tr
><tr
id=sl_svn4_26

 onmouseover="gutterOver(26)"

><td class="source">        m_textView = (TextView) findViewById(R.id.textView1);<br></td></tr
><tr
id=sl_svn4_27
...
><td class="source">        MAP_DEFAULT_LATITUDE = getIntent().getExtras().getDouble(&quot;latitude&quot;);<br></td></tr
><tr
id=sl_svn4_29

 onmouseover="gutterOver(29)"

><td class="source">        MAP_DEFAULT_LONGITUDE = getIntent().getExtras().getDouble(&quot;longitude&quot;);<br></td></tr
><tr
id=sl_svn4_30
...
><td class="source">        m_textView.setText(&quot;Latitude = &quot; + MAP_DEFAULT_LATITUDE + &quot;,&quot; + &quot;Longitude = &quot; + MAP_DEFAULT_LONGITUDE);<br></td></tr
><tr
id=sl_svn4_32
...
><td class="source">        m_mapView.setBuiltInZoomControls(true);<br></td></tr
><tr
id=sl_svn4_34

 onmouseover="gutterOver(34)"

><td class="source">        m_mapView.setMultiTouchControls(true);<br></td></tr
><tr
id=sl_svn4_35

 onmouseover="gutterOver(35)"

><td class="source">        m_mapView.setClickable(true);<br></td></tr
><tr
id=sl_svn4_36

 onmouseover="gutterOver(36)"

><td class="source">        m_mapView.setUseDataConnection(false);<br></td></tr
><tr
id=sl_svn4_37

 onmouseover="gutterOver(37)"

><td class="source">        m_mapView.getController().setZoom(MAP_DEFAULT_ZOOM);<br></td></tr
><tr
id=sl_svn4_38

 onmouseover="gutterOver(38)"

><td class="source">        m_mapView.getController().setCenter(<br></td></tr
><tr
id=sl_svn4_39

 onmouseover="gutterOver(39)"

><td class="source">        			new GeoPoint(MAP_DEFAULT_LATITUDE, MAP_DEFAULT_LONGITUDE));<br></td></tr
><tr
id=sl_svn4_40

 onmouseover="gutterOver(40)"

><td class="source">        m_mapView.setTileSource(TileSourceFactory.MAPNIK);<br></td></tr
><tr
id=sl_svn4_41
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/landmarkloc/source/detail?spec=svn4&amp;r=4">r4</a>
 by rahulveera2009@gmail.com
 on Mar 29, 2012
 &nbsp; <a href="/p/landmarkloc/source/diff?spec=svn4&r=4&amp;format=side&amp;path=/trunk/Osmmap.java&amp;old_path=/trunk/Osmmap.java&amp;old=">Diff</a>
 </div>
 <pre>OpenStreetMap</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/landmarkloc/source/detail?r=4&spec=svn4';
 var publish_url = '/p/landmarkloc/source/detail?r=4&spec=svn4#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/Osmmap.java');
 changed_urls.push('/p/landmarkloc/source/browse/trunk/Osmmap.java?r\x3d4\x26spec\x3dsvn4');
 
 var selected_path = '/trunk/Osmmap.java';
 ...
 <option value="/p/landmarkloc/source/browse/trunk/Osmmap.java?r=4&amp;spec=svn4"
 selected="selected"
 >/trunk/Osmmap.java</option>
 ...
 <a class="ifOpened" href="/p/landmarkloc/source/detail?r=4&spec=svn4#publish">Publish your comments</a>
 ...
 <a href="/p/landmarkloc/source/list?path=/trunk/Osmmap.java&start=4">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//landmarkloc.googlecode.com/svn/trunk/Osmmap.java">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn4': '/trunk/Osmmap.java'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl":"","assetVersionPath":"http://www.gstatic.com/codesite/ph/16876283342775096309","domainName":null,"assetHostPath":"http://www.gstatic.com/codesite/ph","token":"EriFFnQ3ojVGygN--kN3O9097B0:1376910200872","projectName":"landmarkloc","loggedInUserEmail":"rahulveera2009@gmail.com","projectHomeUrl":"/p/landmarkloc","profileUrl":"/u/101147021809914525860/"}, '', 'svn4', paths,
